...
function Topic() {
  ...
  return (
    <Container className="mt-5 project-topic">
      <Row>
        <h1>
          <i class="bi bi-kanban-fill color-txt-blue-500 me-2"></i>
          {topic}
        </h1>
      </Row>
        ...
        <Card className="project-card" onClick={() => ModalShow(project)}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              <p className="color-txt-gray-500">{project.miniDetail}</p>
            </Card.Text>
          </Card.Body>
        </Card>
      </Col>
  ...
  if (modalShow) {
    return (
      ...
      >
        ...
        <Modal.Body>
          <img src={"images/Project/" + modalData.image} className="mb-4"></img>
          <h6 className="mb-2 color-txt-zinc-700">
            {"year : " + modalData.year}
          </h6>
          <p className="color-txt-gray-500">{modalData.detail}</p>
  ...
  if (link !== "#")
    return (
      <Button
        ...
        className="pt-0-6"
      >
        Visit<i class="bi bi-arrow-right-circle-fill ms-2"></i>
      </Button>
    );
  else
    return (
      <Badge bg="warning" className="color-txt-yellow-800 pt-0-5">
        Sorry out of order
      </Badge>
    );
}
