...
//data
import Data from "./Award/Award.json";
  ...
  return (
    <Container className="mt-5 award-topic">
      <Row>
        {" "}
        <h1>
          <i class="bi bi-award-fill color-txt-orange-500 me-2"></i>
          {topic}
        </h1>
      </Row>
        ...
        <Card className="award-card" onClick={() => ModalShow(award)}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              <p className="color-txt-gray-500">{award.miniDetail}</p>
            </Card.Text>
          </Card.Body>
        </Card>
      </Col>
  ...
  if (modalShow) {
    return (
      ...
      >
        ...
        <Modal.Body>
          <img src={"images/Award/" + modalData.image} className="mb-4"></img>
